...
<body>
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="../lang/index.php"><img class="navbar-logo" src="../../public/img/logo.png" alt="error"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="logout.php"><i class="fa-solid fa-language"></i> Logout</a>
                </li>
            </ul>
        </div>
    </nav>
